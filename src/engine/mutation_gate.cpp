...
std::variant<MutationRequest, std::string> validate_player_move(const World &world,
    ...
    return MutationRequest{
        MutationRequest::Type::PlayerMove, MutationRequest::Source::Player, "player",
...
std::variant<MutationRequest, std::string> validate_player_take(const World &world,
    ...
    return MutationRequest{
        MutationRequest::Type::PlayerTake, MutationRequest::Source::Player, "player",
        {{"item_id", *item_it}}};
}
...
std::variant<MutationRequest, std::string> validate_player_drop(const World &world,
    ...
    return MutationRequest{
        MutationRequest::Type::PlayerDrop, MutationRequest::Source::Player, "player",
        {{"item_id", *item_it}}};
}
